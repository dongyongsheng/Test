...
public class CRC16 {
	...
	public static int calcCrc16(byte[] data, int offset, int len, int preval) {
		...
		System.out.println((ucCRCLo & 0x00ff) & 0xffff );
		System.out.println(((ucCRCHi & 0x00ff) << 8) );
		return  (ucCRCLo & 0x00ff) & 0xffff |((ucCRCHi & 0x00ff) << 8) ;
	}

	// 测试
	public static void main(String[] args) {
		// 0x02 05 00 03 FF 00 , crc16=7C 09
		int crc = CRC16.calcCrc16(new byte[] { (byte)0xFB, (byte)0x06, (byte)0x0E, (byte)0xAA, (byte) 0xA0, (byte)0x00 });
