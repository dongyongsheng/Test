...
public class BytesInputStream
	...
	/**
	 * Constructs a new <tt>BytesInputStream</tt> instance, with an empty
	...
	/**
	 * Constructs a new <tt>BytesInputStream</tt> instance, that will read
	 * from the given data.
	 * 
	 * @param data
	...
	/**
	 * Resets this <tt>BytesInputStream</tt> using the given byte[] as new
	 * input buffer.
	 * 
	 * @param data
	...
	/**
	 * Resets this <tt>BytesInputStream</tt> using the given byte[] as new
	 * input buffer and a given length.
	 * 
	 * @param data
	 *            a byte array with data to be read.
	 * @param length
